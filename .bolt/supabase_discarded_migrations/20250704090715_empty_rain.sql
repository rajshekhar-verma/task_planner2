/*
  ...
  1. New Tables
    - `tax_payments`
      ...
      - `payment_date` (date, when the tax payment was made)
  ...
  3. Indexes
    - Add indexes for better query performance on payment_date and created_at
*/
...
CREATE POLICY "Users can manage tax payments"
  ON tax_payments
  FOR ALL
  TO public
  USING (true)
